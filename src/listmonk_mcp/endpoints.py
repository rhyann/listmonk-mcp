...
ENDPOINTS: dict[str, Endpoint] = {
    ...
    "api_create_subscriber": _e("POST", "/api/subscribers", "Create a subscriber.", body_required=True),
    "api_send_subscriber_optin": _e("POST", "/api/subscribers/{subscriber_id}/optin", "Send an opt-in confirmation.", True),
    "api_public_subscribe": _e("POST", "/api/public/subscription", "Create a public subscription.", body_required=True),
    "api_update_subscriber_lists": _e("PUT", "/api/subscribers/lists", "Modify subscriber list memberships.", body_required=True),
    ...
    "api_query_update_subscriber_lists": _e("PUT", "/api/subscribers/query/lists", "Bulk modify list memberships by query.", True, body_required=True),
    "api_update_subscriber": _e("PUT", "/api/subscribers/{subscriber_id}", "Replace a subscriber.", body_required=True),
    "api_patch_subscriber": _e("PATCH", "/api/subscribers/{subscriber_id}", "Partially update a subscriber.", body_required=True),
    "api_set_subscriber_blocklist": _e("PUT", "/api/subscribers/{subscriber_id}/blocklist", "Set one subscriber's blocklist state."),
    "api_set_subscribers_blocklist": _e("PUT", "/api/subscribers/blocklist", "Set blocklist state for selected subscribers.", True, body_required=True),
    ...
    "api_create_list": _e("POST", "/api/lists", "Create a mailing list.", body_required=True),
    "api_update_list": _e("PUT", "/api/lists/{list_id}", "Update a mailing list.", body_required=True),
    "api_delete_list": _e("DELETE", "/api/lists/{list_id}", "Delete a mailing list.", True),
    "api_delete_lists": _e("DELETE", "/api/lists", "Delete multiple mailing lists.", True, query_required=True),
    ...
    "api_change_campaign_status": _e("PUT", "/api/campaigns/{campaign_id}/status", "Change campaign status.", True, body_required=True),
    "api_set_campaign_archive": _e("PUT", "/api/campaigns/{campaign_id}/archive", "Change campaign archive publication.", body_required=True),
    "api_delete_campaign": _e("DELETE", "/api/campaigns/{campaign_id}", "Delete a campaign.", True),
    "api_delete_campaigns": _e("DELETE", "/api/campaigns", "Delete multiple campaigns.", True, query_required=True),
    ...
    "api_delete_bounces": _e("DELETE", "/api/bounces", "Delete selected or all bounce records.", True, query_required=True),
    "api_record_bounce": _e("POST", "/webhooks/bounce", "Record a bounce event."),

    # Transactional delivery.
    "api_send_transactional": _e("POST", "/api/tx", "Send a transactional message.", True, body_required=True),
